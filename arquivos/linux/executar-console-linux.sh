...
comando="'$caminho_java' -jar -Dvisualvm.display.name=Portugol-Studio -Xms32m -Xmx256m -XX:MinHeapFreeRatio=5 -XX:MaxHeapFreeRatio=10 -XX:+UseG1GC -XX:+CMSClassUnloadingEnabled portugol-console.jar"
